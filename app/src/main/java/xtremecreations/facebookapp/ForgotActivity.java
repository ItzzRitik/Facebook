...
public class ForgotActivity extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ForgotActivity.this.getSupportActionBar().setTitle(title);
        ForgotActivity.this.getSupportActionBar().setBackgroundDrawable(new ColorDrawable(Color.parseColor("#3B5998")));
        ForgotActivity.this.getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        ForgotActivity.this.getSupportActionBar().setElevation(0);

        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP){ForgotActivity.this.getWindow().setStatusBarColor(ContextCompat.getColor(ForgotActivity.this, R.color.status));}
        ...
        wb.setWebViewClient(new WebViewClient() {
            ...
            public void onReceivedError(WebView view, int errorCode, String description, String failingUrl) {
                Toast.makeText(ForgotActivity.this, "Error Occured", Toast.LENGTH_LONG).show();finish();}
            @Override
            ...
            public void onPageFinished(WebView v, String url) {
                if (page == 0) {
                    ...
                    if (wb.getUrl().equals("https://m.facebook.com/login/identify/?ctx=recover")) {
                        Toast.makeText(ForgotActivity.this, "Invalid Email ID", Toast.LENGTH_LONG).show();
                        finish();
                    }
                    else if (wb.getUrl().equals("https://m.facebook.com/login/")){finish();}
